...
7. **Макет и код разошлись:** в Figma `HeroScreen` всё ещё с росчерками и медиа-карточкой, в коде — простой центрированный текст; а `VacancyList` в Figma — фильтры над списком, в коде — левый рельс.

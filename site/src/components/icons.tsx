/* Иконки Lucide — те же, что в библиотеке HR Icons. Соцсети VK и Telegram — официальные брендмарки. */
...
/* Telegram — официальный брендмарк (Simple Icons) */
...
/* VK — официальный брендмарк (Simple Icons) */
export const IconVk = ({ size = 20, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
